...
OPENVINO_INSTALL_DIR="/opt/intel/openvino_2025"

wget -O openvino.tgz https://storage.openvinotoolkit.org/repositories/openvino/packages/2025.1/linux/openvino_toolkit_ubuntu24_2025.1.0.18503.6fec06580ab_x86_64.tgz
tar -xvf openvino.tgz
sudo mkdir -p ${OPENEVINO_INSTALL_DIR}
sudo mv openvino_toolkit_ubuntu24_2025.1.0.18503.6fec06580ab_x86_64 ${OPENEVINO_INSTALL_DIR}}
